...
class Regions(str):
    ...
    BACCUS_PIER = "Baccus Pier"
    BACCUS_VILLAGE = "Baccus Village"
    CENTRAL_PARK = "Central Park"
    CHARITY_SQUARE = "Charity Square"
    CIVILIZATION_ROOM = "Civilization Room"
    CLOCK_TOWER_ENTRANCE = "Clock Tower Entrance"
    CLOCK_TOWER_HALFWAY_UP = "Clock Tower Halfway Up"
    CLOCK_TOWER_ENGINE_ROOM = "Clock Tower Engines Room"
    CRY_ROOM = "Crying Room"
    DRIED_WISHING_WELL = "Dried Wishing Well"
    ...
    HAUNTED_MANSION_EAST = "East Side Of Mansion"
    HAUNTED_MANSION_NORTH = "North Side Of Mansion"
    HAUNTED_MANSION_SOUTH = "South Side Of Mansion"
    HAUNTED_MANSION_WEST = "West Side Of Mansion"
    HIDDEN_VILLAGE = "Hidden Village"
    HIDING_ROOM = "Hidding Room"
    HUNDRED_YEAR_OLD_MANS_HUT = "100 Year Old Man's Hut"
    IRON_CASTLE_ENTRANCE = "Iron Castle Entrance"
    IRON_CASTLE_MAIN_ROOM = "Iron Castle Main Room"
    IRON_CASTLE_LEFT_ROOM = "Iron Castle Left Room"
    IRON_CASTLE_RIGHT_ROOM = "Iron Castle Right Room"
    ...
    MANSION = "Mansion"
    MANSION_JUNGLE_PIG_ROOM = "Mansion Grandfather Clock Room"
    MANSION_STAIRS_UP = "Mansion Ascending Stairs"
    MANSION_STAIRS_DOWN = "Mansion Descending Stairs"
    MASAKARI_JUNGLE = "Masakari Jungle"
    MASAKARI_RIVER = "Masakari River"
    ...
    STORMY_MOUNTAIN_BIS = "Stormy Mountain (Part 2)"
    SUNNY_ROOM = "Sunny Room"
    SUN_TORCH_STAND = "Sun Torch Stand"
    SWIMMING_ROOM = "Swimming Room"
    TEN_THOUSAND_YEAR_OLD_MANS_ROOM = "10,000 Year Old Man's Room"
    THE_MERMAIDS_SINGING_BEACH = "The Mermaid's Singing Beach"
    THE_MERMAIDS_SINGING_ROCK = "The Mermaid's Singing Rock"
    THE_STRANGE_SMALL_ROOM = "The Strange Small Room"
    THIEFS_ROOM_ONE = "Thief's Room One"
    THIEFS_ROOM_THREE = "Thief's Room Three"
    THIEFS_ROOM_TWO = "Thief's Room Two"
    THOUSAND_YEAR_OLD_MANS_ROOM = "1,000 Year Old Man's Room"
    TRAP_ROOM = "Trap Room"
    TRIBULATION_ROOM = "Room Of Tribulation"
