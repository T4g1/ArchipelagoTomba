...
class ItemHandler:
    item_table: list[ItemData] = [
        ...
        ItemData(0x13, IC.progression, Items.DIRTY_MIRROR),
        ...
        ItemData(0x26, IC.progression, Items.ORANGE_EVIL_PIG_BAG),
        ItemData(0x27, IC.progression, Items.YELLOW_EVIL_PIG_BAG),
        ItemData(0x28, IC.progression, Items.GREEN_EVIL_PIG_BAG),
        ItemData(0x29, IC.progression, Items.BLUE_EVIL_PIG_BAG),
        ItemData(0x2A, IC.progression, Items.NAVY_EVIL_PIG_BAG),
        ItemData(0x2B, IC.progression, Items.PINK_EVIL_PIG_BAG),
        ItemData(0x2C, IC.progression, Items.TEN_THOUSAND_YEAR_OLD_KEY),
        ItemData(0x2D, IC.progression, Items.MILLION_YEAR_OLD_KEY),
        ItemData(0x2E, IC.progression, Items.LARGE_KEY_PANEL_1),
        ItemData(0x2F, IC.progression, Items.LARGE_KEY_PANEL_2),
        ItemData(0x30, IC.progression, Items.LARGE_KEY_PANEL_3),
        ItemData(0x31, IC.progression, Items.LARGE_KEY_PANEL_4),
        ItemData(0x32, IC.progression, Items.LARGE_KEY_PANEL_5),
        ItemData(0x33, IC.progression, Items.FUEL_BAR),
        # ItemData(0x34, IC.filler, Items.RAIN_ESSENCE),
        ItemData(0x35, IC.progression, Items.BIG_KEY),
        ItemData(0x36, IC.progression, Items.SMALL_KEY),
        ItemData(0x37, IC.progression, Items.CHEESE, True, 15),
        ...
        ItemData(0x3C, IC.progression, Items.BOMB),
        ...
        ItemData(0x44, IC.progression, Items.MATH_BEAD_2),
        ItemData(0x45, IC.progression, Items.MATH_BEAD_3),
        ItemData(0x46, IC.progression, Items.MATH_BEAD_4),
        ItemData(0x47, IC.progression, Items.MATH_BEAD_5),
        ItemData(0x48, IC.progression, Items.MATH_BEAD_6),
        ItemData(0x49, IC.progression, Items.MATH_BEAD_7),
        ...
        ItemData(0x59, IC.progression, Items.GOLD_MEDAL),
        # ItemData(0x5A, IC.filler, Items.LETTER),
        # ItemData(0x5B, IC.filler, Items.WOOD),
        ItemData(0x5C, IC.progression, Items.RAFT),
        ItemData(0x5D, IC.progression, Items.GOLDEN_LEAF_BUTTERFLY),
        ItemData(0x5E, IC.progression, Items.GOLDEN_FRUIT),
        ItemData(0x5F, IC.progression, Items.GOLD_FLOWER),
        ItemData(0x60, IC.filler, Items.PSYCHIC_FISH),
        # ItemData(0x61, IC.filler, Items.SHOVEL),
        ItemData(0x62, IC.progression, Items.JEWEL_OF_FIRE),
        ...
        ItemData(0x66, IC.progression, Items.SILVER_POWDER),
        ItemData(0x67, IC.progression, Items.MOLASSES),
        ItemData(0x68, IC.progression, Items.KOKKA_CLAW, True),
        ItemData(0x69, IC.progression, Items.BUTAMUSHI_THORN, True),
        ItemData(0x6A, IC.progression, Items.NEEDLEGATOR_TEETH, True),
        ...
        ItemData(0x79, IC.progression, Items.WEED_KILLER),
        ...
        ItemData(0x7D, IC.progression, Items.FUNGA_DRUM),
        ItemData(0x7E, IC.progression, Items.MIGHTY_FISH_FOOD),
        ...
        ItemData(0x8B, IC.progression, Items.BANANA_JUICE),
        # ItemData(0x8C, IC.filler, Items.ITEM),
        ItemData(0x8D, IC.progression, Items.CHARLES_PANTS),
        ...
        ItemData(0x9D, IC.progression, Items.KNOWLEDGE_FRUIT),
